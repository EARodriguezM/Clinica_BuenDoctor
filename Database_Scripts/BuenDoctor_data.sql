...
CREATE TABLE [DATA_USER](
    ...
    CONSTRAINT [DATA_USER_PHONE_UK] UNIQUE ([PHONE]),
    CONSTRAINT [DATA_USER_PHONE_CK] CHECK([PHONE] LIKE '+%'),
...
SET ANSI_PADDING ON
GO
CREATE TABLE [R-DATA_USER-USER_TYPE](
    [R-DATA_USER-USER_TYPE_ID] NVARCHAR(10) NOT NULL,
	[DATA_USER_ID] NVARCHAR(10) NOT NULL,
	[USER_TYPE_ID] TINYINT NOT NULL,
    [STATUS] BIT DEFAULT 1 NOT NULL,
    CONSTRAINT [R-DATA_USER-USER_TYPE_PK] PRIMARY KEY ([R-DATA_USER-USER_TYPE_ID]),
    CONSTRAINT [R-DATA_USER-USER_TYPE_FK--USER] FOREIGN KEY ([DATA_USER_ID]) REFERENCES [DATA_USER]([DATA_USER_ID]),
    CONSTRAINT [R-DATA_USER-USER_TYPE_FK--USER_TYPE] FOREIGN KEY ([USER_TYPE_ID]) REFERENCES [USER_TYPE](USER_TYPE_ID),
    CONSTRAINT [R-DATA_USER-USER_TYPE_STATUS_CK] CHECK([STATUS] = 1 OR [STATUS] = 0) 
);
GO
SET ANSI_PADDING OFF
GO
